export type RealPriceShowcaseLink = { title: string; description: string; route: string };

export const realPriceStorySteps = ['成交資料', '社區行情', '市場比較', '區域地圖分析', '生活圈智慧分析', '市場提案'] as const;
...
export const realPriceToolEntries: RealPriceShowcaseLink[] = [
  ...
  { title: '區域地圖分析', description: '以高雄區域示意地圖查看價格、成交量與生活圈標籤。', route: '/tools/real-price/map' },
