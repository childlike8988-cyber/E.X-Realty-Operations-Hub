...
{id:'training-center',title:'房仲 AI 實戰訓練中心',description:'以 Mock 情境建立接待、帶看、行情與議價訓練基礎。',route:'/training',icon:'GraduationCap',category:'共用',allowedRoles:['ADMIN','SALES','MANAGER','VIEWER'],status:'beta',version:'0.1'},
...
const navigationSubtitles: Record<string, string> = {
  ...
  'training-center': 'AI Realty Training Center',
